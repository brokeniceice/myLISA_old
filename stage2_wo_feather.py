...
def parse_args():
    ...
    parser.add_argument("--output_dir", type=str, default="./checkpoints_stage2/wo_feather_half_hint_epoch2")
    ...
    for epoch in range(args.epochs):
        ...
        for step, batch in enumerate(pbar):
            with accelerator.accumulate(model):
                ...
                accelerator.unwrap_model(model).get_model().current_images_npr = None
