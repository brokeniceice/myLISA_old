...
def sync_vocab_size_in_config(config):
...
def main():
    ...
    cfg = sync_vocab_size_in_config(cfg)

    print("🚀 加载模型本体...")
    model = LISAForCausalLM.from_pretrained(
        args.version, config=cfg, low_cpu_mem_usage=True, seg_token_idx=args.seg_token_idx, torch_dtype=torch_dtype
    )
